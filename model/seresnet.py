...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, drop_rate=0.2,
        ...
        self.ms2 = MultiScaleSEv2(256, 512, 512, 16, (1, 2, 3), 32, msconv_low=True)
        self.ms3 = MultiScaleSEv2(512, 1024, 1024, 16, (1, 2, 3), 32, msconv_low=True)
        self.ms4 = MultiScaleSEv2(1024, 2048, 2048, 16, (1, 2, 3), 32, msconv_low=True)
...
def _create_senet(variant, pretrained=False, **kwargs):
    ...
    url = '/home/alex/.cache/torch/hub/checkpoints/se_resnet50-ce0d4300.pth'
    if pretrained:
        ...
        for k, v in state_dict.items():
            if k in model_dict and 'last_linear' not in k:
                pretrained_dict[k] = v
